...
#
TOP = /Users/steve/Desktop/sqlite
...
#
TCC += -I/opt/homebrew/Cellar/tcl-tk/8.6.13_2/include/tcl-tk

# The library that programs using TCL must link against.
#
LIBTCL = -L/opt/homebrew/Cellar/tcl-tk/8.6.13_2/lib -ltcl8.6
...
#
TCLLIBDIR = /opt/homebrew/Cellar/tcl-tk/8.6.13_2/lib/tcl8.6/sqlite3
...
SQLITE3_SHELL_TARGET   = $(SQLITE3_SHELL_TARGET_)
...
libtclsqlite3.la:	tclsqlite.lo libsqlite3.la
	$(LTLINK) -no-undefined -o $@ tclsqlite.lo \
		libsqlite3.la -L/opt/homebrew/Cellar/tcl-tk/8.6.13_2/lib -ltclstub8.6 $(TLIBS) \
		-rpath "$(TCLLIBDIR)" \
		-version-info "8:6:8" \
		-avoid-version
